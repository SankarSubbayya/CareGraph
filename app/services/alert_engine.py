...
_EMERGENCY_WORDS = {"fall", "fell", "fallen", "chest pain", "can't breathe", "emergency", "stroke", "bleeding"}


def _unique_concerns_preserve_order(concerns: list) -> list[str]:
    """Drop duplicate concern strings (case-insensitive) while keeping first occurrence order."""
    seen: set[str] = set()
    out: list[str] = []
